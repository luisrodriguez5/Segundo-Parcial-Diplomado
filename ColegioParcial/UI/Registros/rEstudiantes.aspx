<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="rEstudiantes.aspx.cs" Inherits="ColegioParcial.UI.Registros.rEstudiantes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-header text-center col-8">
        <h1><strong>Registro Estudiantes</strong></h1>
        <br />
    ...
    <div class="form-group row col-9">
        <label for="Fechainput" class="col-sm-4 col-form-label text-right">Fecha</label>
        <div class="col-sm-4">
            <asp:TextBox ID="FechaTextBox" CssClass="form-control" runat="server" TextMode="Date"></asp:TextBox>
        </div>
    </div>
